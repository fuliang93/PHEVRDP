...
# Solve the vrptw
# =============================================================================
def vrpSol_ini(data,localSearchTime):
    ...
    # When an initial solution is given for search, the model will be closed with the default search parameters unless it is explicitly closed with the custom search parameters.
